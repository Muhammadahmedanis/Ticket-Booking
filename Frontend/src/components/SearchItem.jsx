...
function SearchItem() {
  return (
    <div className='searchItem border border-gray-400 rounded flex flex-wrap justify-between gap-4 mb-5 p-5'>
        <img src="https://cf2.bstatic.com/xdata/images/hotel/square240/597733028.jpg?k=f4dbee0ef4cf96aaebb8b5eb92cf20fbfbe60445c661aa96f27cf40f1b24c593&o=" alt="" className="siImg object-cover h-[200px] w-full md:w-[200px] lg:w-[200px]" />
